...
class _C {
  ...
  static const LinearGradient remarkGrad = LinearGradient(
    colors: [Color(0xFF3E7A53), Color(0xFF52A06B)],
    begin: Alignment.topCenter,
    end: Alignment.bottomCenter,
  );
  static const LinearGradient shareGrad = LinearGradient(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: widget.onTap == null
              ...
              : [
            BoxShadow(
                color: (widget.color ?? const Color(0xFF2D5A3D))
  ...
  Widget build(BuildContext context) => AnimatedBuilder(
    ...
    builder: (_, __) => Stack(children: [
      Container(
          height: 8,
          decoration: BoxDecoration(
              color: widget.bg, borderRadius: BorderRadius.circular(8))),
                      ...
                      child: Column(
                          ...
                          children: [
                            Row(children: [
                              ...
                              Text("AUTHORITY REMARK",
                                  style: _T.label.copyWith(
                                      color: _C.remarkTitle,
                                      letterSpacing: 1.0)),
                            ]),
    ...
    child: Row(children: [
      ScaleTransition(
        ...
        child: Container(
          ...
          height: 28,
          decoration: BoxDecoration(
              color: _C.alertRed.withValues(alpha: 0.12),
              shape: BoxShape.circle),
          child: const Icon(Icons.campaign_rounded,
              color: _C.alertRed, size: 15),
        ),
      ),
...
class _SocialShareDialog extends StatefulWidget {
  ...
  const _SocialShareDialog(
      {required this.complaint, required this.onConfirmShare});
...
class _SocialShareDialogState extends State<_SocialShareDialog>
  ...
  String get _description =>
      _safe(widget.complaint['description'], 'No description provided.');
  String get _dateStr => () {
  ...
  String get _shortId => _fullId.length > 8
      ? _fullId.substring(_fullId.length - 8).toUpperCase()
      : _fullId.toUpperCase();
  String get _lat =>
      widget.complaint['location']?['lat']?.toStringAsFixed(5) ?? 'N/A';
  String get _lng =>
      widget.complaint['location']?['lng']?.toStringAsFixed(5) ?? 'N/A';
                  ...
                  child: Row(children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        shape: BoxShape.circle,
                        border: Border.all(
                            color: _C.alertRed.withValues(alpha: 0.4)),
                      ),
                      child: const Icon(Icons.campaign_rounded,
                          color: _C.alertRed, size: 20),
                    ),
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              Text('Review before sharing publicly',
                                  style: TextStyle(
                                      color: _C.shareSubText, fontSize: 11.5)),
                            ])),
                    GestureDetector(
                        ...
                        children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Column(children: [
                                      ...
                                      _PreviewRow(
                                          ...
                                          label: 'Escalation',
                                          value:
                                          'Level $_escalLvl — $_status',
                                          valueColor: _C.alertOrange),
                                      _PreviewRow(
                          ...
                          Container(
                            ...
                            child: TextField(
                              controller: _tagCtrl,
                              style: const TextStyle(
                                  color: _C.shareText, fontSize: 14),
                              cursorColor: _C.g400,
                          ...
                          const Text(
                              'Tag will be included in the shared message',
                              style: TextStyle(
                                  color: _C.shareSubText, fontSize: 11)),
                        ]),
                  ),
                ),
                Padding(
      ...
      AnimatedBuilder(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              color: _C.g50,
              shape: BoxShape.circle,
              border: Border.all(color: _C.g100, width: 2)),
          child:
          const Icon(Icons.inbox_outlined, size: 44, color: _C.g300),
        ),
      ),
      const SizedBox(height: 24),
      Text(AppText.t("noComplaints"),
          style: _T.h2.copyWith(color: _C.smoke)),
      const SizedBox(height: 8),
    ...
    children: [
      AnimatedBuilder(
        ...
        builder: (_, child) => Transform.rotate(
            angle: _rot.value * 2 * math.pi, child: child),
        child: Container(
          width: 52,
          height: 52,
          decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                    color: _C.g800.withValues(alpha: 0.25),
                    blurRadius: 14)
              ]),
          child: const Padding(
...
class _HeroBgPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(
        Offset(size.width * 0.85, size.height * 0.2), size.width * 0.4, p);
    canvas.drawCircle(
        Offset(size.width * 0.1, size.height * 0.9), size.width * 0.3, p);
        ...
        return GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(10),
              border: Border.all(
                  color: active ? Colors.transparent : _C.g200),
              boxShadow: active
                  ? [
                BoxShadow(
                    color: _C.g800.withValues(alpha: 0.22),
                    blurRadius: 10,
...
class _BottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(
        color: _C.white, borderRadius: BorderRadius.circular(28)),
    child: Padding(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        Container(
            ...
            height: 4,
            decoration: BoxDecoration(
                color: _C.g200, borderRadius: BorderRadius.circular(2))),
        const SizedBox(height: 24),
        Container(
            width: 60,
            height: 60,
              ...
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  child: Text(cancelLabel,
                      textAlign: TextAlign.center,
                      style: _T.h3.copyWith(color: _C.stone)),
                ),
              )),
          const SizedBox(width: 12),
          Expanded(
...
class _ComplaintCardState extends State<_ComplaintCard>
  ...
  Widget build(BuildContext context) {
    ...
    widget.isDeadlinePassed(c['deadline']);
    final int escalationLevel = (c['escalationLevel'] ?? 0) as int;
    final bool finalEscalation =
        escalationLevel >= widget.authorityLevels.length - 1;
    ...
    switch (c['status']) {
      case 'Resolved':
        progressColor = _C.g500;
        break;
      case 'Escalated':
        progressColor = _C.orange;
        break;
      default:
        progressColor = _C.amber;
    }

    late LinearGradient stripeGrad;
    if (resolved) {
      stripeGrad = _C.primaryGrad;
    } else if (c['status'] == 'Escalated') {
      stripeGrad = _C.orangeGrad;
    } else {
      stripeGrad = _C.goldGrad;
    }
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
                color: _C.g800.withValues(alpha: 0.07),
                blurRadius: 20,
        ...
        child: ClipRRect(
          ...
          child: Column(
              ...
              children: [
                ...
                Container(
                    height: 4,
                    decoration: BoxDecoration(gradient: stripeGrad)),
                ...
                Padding(
                  ...
                  child: Column(
                      ...
                      children: [
                              ...
                              child: Row(
                                  ...
                                  children: [
                                    const Icon(Icons.shield_outlined,
                                        size: 12, color: _C.g500),
                                    const SizedBox(width: 4),
                                    Text(AppText.t("anonymous"),
                                        style: _T.label
                                            .copyWith(color: _C.g600)),
                                  ]),
                            ),
                          if (c['status'] == 'Pending')
                            GestureDetector(
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    Text("Assigned Authority",
                                        style: _T.label),
                                    const SizedBox(height: 2),
                                    Text(c['assignedAuthority'] ?? 'N/A',
                                        style:
                                        _T.h3.copyWith(fontSize: 13)),
                                  ])),
                        ]),
                        ...
                        _EscalationTimeline(
                          current: escalationLevel.clamp(
                              0, widget.authorityLevels.length - 1),
                        ...
                        Row(
                            ...
                            children: [
                              Text(
                                  "Level $escalationLevel / ${widget.authorityLevels.length - 1}",
                                  style: _T.label),
                        ...
                        Container(
                          ...
                          child: Column(
                              ...
                              children: [
                                Text("Details",
                                    style:
                                    _T.label.copyWith(color: _C.g700)),
                                const SizedBox(height: 10),
                                ...
                                if (c['location'] != null) ...[
                                  ...
                                  Row(children: [
                                    ...
                                    const SizedBox(width: 5),
                                    Text(
                                        "${c['location']['lat']?.toStringAsFixed(4) ?? '?'}, ${c['location']['lng']?.toStringAsFixed(4) ?? '?'}",
                                        style: _T.body
...
class _ComplaintHistoryPageState extends State<ComplaintHistoryPage>
  ...
  Future<void> escalateComplaint(Map<String, dynamic> complaint) async {
    ...
    try {
      ...
      if (!mounted) return;
      if (res.statusCode == 200) {
        _showSuccessDialog(AppText.t("escalationConfirmed"),
            AppText.t("escalationSuccess"));
      } else {
  ...
  void confirmSocialShare(Map<String, dynamic> complaint) {
    showDialog(
      ...
      builder: (_) => _SocialShareDialog(
          complaint: complaint, onConfirmShare: () {}),
    );
  }
    ...
    showDialog(
      ...
      builder: (_) => Dialog(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              color: _C.white, borderRadius: BorderRadius.circular(24)),
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            Container(
              width: 64,
              height: 64,
              decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                        color: _C.g800.withValues(alpha: 0.30),
                        blurRadius: 16)
                  ]),
          ...
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              background: Stack(fit: StackFit.expand, children: [
                Container(
                    decoration:
                    const BoxDecoration(gradient: _C.primaryGrad)),
                Positioned.fill(
